if [ -z "$SINGULARITY_NAME" ]; then
    alias runsin="cd /home/eagle8 && singularity exec --nv -B /run jetson_6_2.sif /bin/bash"
fi

if [ -z "$singularity" ]; then
        alias runlivox="cd /home/eagle8 &&  singularity exec --nv -B /run dlio_jetpack6_ros2_gtsam_livox.sif /bin/bash"
fi
# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/eagle8/acp_ws/src/acados/lib
# export ACADOS_SOURCE_DIR=/home/eagle8/acp_ws/src/acados
. "$HOME/.cargo/env"
...
#alias acp_build="colcon build --symlink-install --cmake-args -DCMAKE_BUILD_TYPE=Release -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DMUJOCO_ROOT_DIR=$COLCON_PAYLOAD_WS_DIR/mujoco-3.4.0 -DCMAKE_BUILD_TYPE=RelWithDebInfo"
colcon_build_pkg() {
  # Usage:
